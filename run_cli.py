...
if __name__ == '__main__':
    # command, yml = "train", "examples/zone/glm3/lora_pt_ml.yaml"
    # command, yml = "train", "examples/zone/glm3/lora_sft_ml.yaml"
    # command, yml = "train", "examples/zone/glm3/lora_pd_ml.yaml"

    # command, yml = "train", "examples/zone/gemma2/lora_sft_ml.yaml"
    # command, yml = "train", "examples/zone/gemma2/lora_pd_ml.yaml"

    # command, yml = "train", "examples/zone/gemma2/lora_pt_yelp.yaml"
    # command, yml = "train", "examples/zone/gemma2/lora_sft_yelp.yaml"
    command, yml = "train", "examples/zone/gemma2/lora_pd_yelp.yaml"
    main(command, yml)